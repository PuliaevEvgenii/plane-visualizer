...
import com.puliaev.graph3d.utils.math.Matrix4Factories;
import com.puliaev.graph3d.utils.math.Vector3;
import com.puliaev.graph3d.utils.math.Vector4;
...
public class SimpleCameraController implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public SimpleCameraController(SimpleCamera camera, ScreenConverter sc) {
        this.camera = camera;
        this.sc = sc;
    }
